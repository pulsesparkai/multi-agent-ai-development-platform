...
```bash
git remote add encore encore://multi-agent-ai-development-platform-ax9i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/multi-agent-ai-development-platform-ax9i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/multi-agent-ai-development-platform-ax9i/settings/integrations/github)
